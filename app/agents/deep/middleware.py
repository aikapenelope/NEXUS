"""Audit and permission middleware for deep agent execution.

Copied from pydantic-deep full_app example (vstorm-co/pydantic-deepagents).
Provides production-grade middleware for sandboxed deep agents:
...
class AuditMiddleware(AgentMiddleware[DeepAgentDeps]):
    """Middleware that tracks tool usage for monitoring.
