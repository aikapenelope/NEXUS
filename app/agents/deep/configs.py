"""Pre-configured deep agent definitions for NEXUS internal use.

These agents run in Docker sandboxes with filesystem access, planning,
and web search.  They are the "cerebro" tools — your personal AI team
for coding, reviewing, and researching.

Usage:
    from app.agents.deep.configs import CODER, REVIEWER, RESEARCHER
    result = await run_deep_agent(CODER, "Fix the failing tests in app/")
"""
...
- Docker, PostgreSQL 17, Redis 7, Prefect 3
...
PROCESS:
1. Clone the repo and read the project structure
...
# ── Researcher: investigates technologies and updates the brain ──────

RESEARCHER = AgentConfig(
    name="nexus-researcher",
    description="Investigates technologies, reads docs, and saves findings to the brain",
    instructions="""\
You are a technical researcher. Your job is to investigate technologies,
frameworks, and tools, then save structured findings to the brain
knowledge base.
...
RESEARCH NOTE FORMAT (save to 03-knowledge/stacks/ or 03-knowledge/business/):
---
